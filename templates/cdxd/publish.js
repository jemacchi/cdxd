 ...
 * @param {array<object>} members.diagrams
...
function buildNav(members) {
	...
	if (Object.keys(diagrams).length) {
		for(var g in diagrams){
            diagramNav += '<li>'+linkto(diagrams[g]._chartType+'-'+diagrams[g]._chartName, diagrams[g]._chartName)+'</li>';
        };
        nav += '<h3>Diagrams</h3><ul>' + diagramNav + '</ul>';	
	}
	// END: Diagrams code
...
exports.publish = function(taffyData, opts, tutorials) {
	...
	if (Object.keys(diagrams).length) {
		for(var g in diagrams){
            generateDiagram('Diagram: ' + diagrams[g]._chartName, diagrams[g], diagrams[g]._chartUrl);
        };
	}
	// END: Diagrams code
